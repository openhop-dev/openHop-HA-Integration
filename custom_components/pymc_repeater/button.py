...
BUTTONS: tuple[PyMCButtonDescription, ...] = (
    PyMCButtonDescription(
        ...
        press_fn=lambda api: api.async_send_advert("flood"),
    ),
    PyMCButtonDescription(
        key="send_direct_advert",
        translation_key="send_direct_advert",
        name="Send direct advert",
        icon="mdi:radio-tower",
        entity_category=EntityCategory.CONFIG,
        press_fn=lambda api: api.async_send_advert("direct"),
    ),
    PyMCButtonDescription(
        key="publish_neighbors",
        translation_key="publish_neighbors",
        name="Publish MQTT neighbors",
        icon="mdi:access-point-network",
        entity_category=EntityCategory.CONFIG,
        press_fn=lambda api: api.async_publish_neighbors(),
    ),
    PyMCButtonDescription(
        key="restart_service",
